...
<html lang="it" >
  <head>
    ...
    <meta name="description" content="Registrati a QUIKUEUE per verificare in real-time gli affollamenti comodamente da casa tua.">
    <meta name="keywords" content="affollamento, covid19, real-time, prenotazione">
    <link rel="icon" href="favicon.png" type="image/png" >
    <title>Registrati - QUIKUEUE</title>
  ...
  <body>
    ...
    <main class="row">
      ...
      <form method="post" onsubmit="return validaForm(username.value, password1.value, password2.value, privacy)" action="iscrizione.php">
          <p><label>E-mail* </label> <input type="text" name="username"></p>
          ...
          <p><output id="livep" ></p>
          <p><label>Consenso al trattamento dei dati* </label><input type="checkbox" name="privacy" id="privacy"></p>
